...
const sampleArticles: Article[] = [
  {
    ...
    content: "<p>Pantheon a organisé une distribution de kits scolaires pour plus de 200 enfants dans les quartiers défavorisés de Cotonou. Cette initiative s'inscrit dans notre engagement pour l'éducation des jeunes.</p>",
    excerpt: "Plus de 200 enfants ont bénéficié de kits scolaires lors de cette journée de solidarité organisée par Pantheon à Cotonou.",
  ...
  },
  {
    ...
    content: "<p>Pantheon a organisé une grande conférence réunissant plus de 300 jeunes leaders de tout le Bénin pour discuter des défis et opportunités du continent africain.</p>",
    excerpt: "300 jeunes leaders réunis pour une conférence sur l'avenir de l'Afrique organisée par Pantheon à Parakou.",
  ...
  },
  {
    ...
    content: "<p>Pantheon lance un programme de formation professionnelle pour 150 jeunes, couvrant des compétences en informatique, entrepreneuriat et développement personnel.</p>",
...
const sampleMembers: BackendMember[] = [
  {
    ...
    title: "Président National Pantheon",
    bio: "Leader visionnaire et engagé pour le développement de l'Afrique, il dirige Pantheon depuis sa fondation avec détermination et passion.",
  ...
  },
  {
    ...
    bio: "Juriste de formation, Aminata coordonne les activités administratives de Pantheon et supervise la mise en œuvre des programmes nationaux.",
  ...
  },
  {
    ...
    bio: "Expert en communication digitale, Koffi dirige la stratégie de communication de Pantheon pour renforcer sa présence sur le plan national et international.",
...
const samplePhotos: BackendPhoto[] = [
  {
    ...
    image: ExternalBlob.fromURL("https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800"),
    category: "evenements",
    caption: "Grande conférence nationale Pantheon — Cotonou",
    display_order: BigInt(0),
    created_at: BigInt(Date.now() * 1_000_000),
  },
  {
  ...
  },
  {
    ...
    category: "leadership",
    caption: "Session de mentorat pour jeunes leaders Pantheon",
    display_order: BigInt(3),
    created_at: BigInt(Date.now() * 1_000_000),
  },
  {
    ...
    category: "evenements",
    caption: "Assemblée générale annuelle du mouvement Pantheon",
