...
import { o as ProtocolError, T as TimeoutWaitingForResponseErrorCode, p as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, q as lookupResultToBuffer, t as RequestStatusResponseStatus, U as UnknownError, v as RequestStatusDoneNoReplyErrorCode, w as RejectError, x as CertifiedRejectErrorCode, y as UNREACHABLE_ERROR, I as InputError, z as InvalidReadStateRequestErrorCode, A as ReadRequestType, P as Principal, B as IDL, D as MissingCanisterIdErrorCode, H as HttpAgent, F as encode, Q as QueryResponseStatus, G as UncertifiedRejectErrorCode, J as isV3ResponseBody, K as isV2ResponseBody, N as UncertifiedRejectUpdateErrorCode, O as UnexpectedErrorCode, V as decode, S as Subscribable, W as pendingThenable, X as resolveEnabled, s as shallowEqualObjects, Y as resolveStaleTime, l as noop$1, Z as environmentManager, $ as isValidTimeout, a0 as timeUntilStale, a1 as timeoutManager, a2 as focusManager, a3 as fetchState, a4 as replaceData, n as notifyManager, r as reactExports, m as shouldThrowError, c as useQueryClient, d as useInternetIdentity, a5 as createActorWithConfig, j as jsxRuntimeExports, a6 as Record, a7 as Opt, a8 as Variant, a9 as Vec, aa as Service, ab as Func, ac as Nat, ad as Tuple, ae as Nat8, af as Text, ag as Bool, ah as Null, ai as Int, aj as Principal$1 } from "./index-CFjb6K-E.js";
...
Service({
  ...
  "_registerAsPresident": Func([], [], []),
  "addAssistantAdmin": Func([Principal$1], [], []),
  "assignCallerUserRole": Func([Principal$1, UserRole$1], [], []),
  "createArticle": Func(
    [Text, Text, Text, ExternalBlob$1, Text],
    [Article],
    []
  ),
  "deleteArticle": Func([Nat], [Bool], []),
  "getAdminList": Func(
    [],
    [Vec(Tuple(Principal$1, Text))],
    ["query"]
  ),
  "getAllArticles": Func([], [Vec(Article)], ["query"]),
  "getArticleById": Func([Nat], [Opt(Article)], ["query"]),
  "getCallerUserRole": Func([], [UserRole$1], ["query"]),
  "getJoinSubmissions": Func([], [Vec(JoinSubmission)], ["query"]),
  "getPresidentPrincipal": Func([], [Opt(Principal$1)], ["query"]),
  "getPublishedArticles": Func([], [Vec(Article)], ["query"]),
  "getRecentArticles": Func([Nat], [Vec(Article)], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "removeAssistantAdmin": Func([Principal$1], [], []),
  "submitJoinForm": Func([Text, Text, Text, Text], [], []),
  "togglePublished": Func([Nat], [Bool], []),
  "updateArticle": Func(
    [Nat, Text, Text, Text, ExternalBlob$1, Text],
    [Bool],
    []
  )
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const JoinSubmission2 = IDL2.Record({
    "id": IDL2.Nat,
    "city": IDL2.Text,
    "name": IDL2.Text,
    "email": IDL2.Text,
    "phone": IDL2.Text,
    "submitted_at": IDL2.Int
  });
  return IDL2.Service({
    ...
    "_registerAsPresident": IDL2.Func([], [], []),
    "addAssistantAdmin": IDL2.Func([IDL2.Principal], [], []),
    "assignCallerUserRole": IDL2.Func([IDL2.Principal, UserRole2], [], []),
    "createArticle": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text, ExternalBlob2, IDL2.Text],
      [Article2],
      []
    ),
    "deleteArticle": IDL2.Func([IDL2.Nat], [IDL2.Bool], []),
    "getAdminList": IDL2.Func(
      [],
      [IDL2.Vec(IDL2.Tuple(IDL2.Principal, IDL2.Text))],
      ["query"]
    ),
    "getAllArticles": IDL2.Func([], [IDL2.Vec(Article2)], ["query"]),
    "getArticleById": IDL2.Func([IDL2.Nat], [IDL2.Opt(Article2)], ["query"]),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getJoinSubmissions": IDL2.Func([], [IDL2.Vec(JoinSubmission2)], ["query"]),
    "getPresidentPrincipal": IDL2.Func([], [IDL2.Opt(IDL2.Principal)], ["query"]),
    "getPublishedArticles": IDL2.Func([], [IDL2.Vec(Article2)], ["query"]),
    "getRecentArticles": IDL2.Func([IDL2.Nat], [IDL2.Vec(Article2)], ["query"]),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "removeAssistantAdmin": IDL2.Func([IDL2.Principal], [], []),
    "submitJoinForm": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Text],
      [],
      []
    ),
    "togglePublished": IDL2.Func([IDL2.Nat], [IDL2.Bool], []),
    "updateArticle": IDL2.Func(
      [IDL2.Nat, IDL2.Text, IDL2.Text, IDL2.Text, ExternalBlob2, IDL2.Text],
      [IDL2.Bool],
      []
    )
  });
...
class Backend {
  ...
  async createArticle(arg0, arg1, arg2, arg3, arg4) {
    if (this.processError) {
      try {
  ...
  async removeAssistantAdmin(arg0) {
    if (this.processError) {
      try {
  ...
  async submitJoinForm(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
  ...
  async updateArticle(arg0, arg1, arg2, arg3, arg4, arg5) {
    if (this.processError) {
      try {
...
async function from_candid_Article_n11(_uploadFile, _downloadFile, value) {
...
async function from_candid_vec_n14(_uploadFile, _downloadFile, value) {
