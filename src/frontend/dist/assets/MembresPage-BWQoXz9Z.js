import { r as reactExports, j as jsxRuntimeExports, R as React } from "./index-CFjb6K-E.js";
import { c as composeRefs, a as useGetMembers } from "./useMembers-D6qzENFO.js";
import { a as clsx, c as cn, L as Layout } from "./Layout-BU-ph7QX.js";
import { S as SectionHeading } from "./SectionHeading-D8_rJWmf.js";
import { c as createLucideIcon, m as motion } from "./backend-DZFzHFEp.js";
    ...
    motion.article,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex flex-col flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-black text-foreground text-xl leading-tight mb-1 truncate", children: member.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary text-sm font-bold mb-1 leading-snug line-clamp-1", children: member.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: "text-xs font-display font-semibold uppercase tracking-wider mb-3",
              style: { color: "var(--pantheon-gold-light)" },
              children: "Membre Pantheon"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-2 w-10 mb-3" }),
...
function MembresPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  background: "radial-gradient(circle, oklch(0.82 0.10 85) 0%, transparent 70%)"
                }
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-display font-semibold text-sm uppercase tracking-widest", children: "Annuaire Pantheon" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl lg:text-6xl font-display font-black text-foreground leading-[1.05] mb-5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative inline-block", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Visionnaires" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.span,
                  {
                    initial: { scaleX: 0 },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg leading-relaxed max-w-xl", children: "Découvrez les figures d'excellence qui portent la vision Pantheon — des leaders engagés, des acteurs du changement." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background border-b border-border/20 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.p,
        {
          initial: { opacity: 0, y: 12 },
          ...
          children: [
            ...
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-bold", children: "15+ pays" }),
            " et représentent l'élite africaine et de la diaspora — une communauté d'excellence au service du continent."
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl mx-auto", children: INTRO_STATS.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm font-display", children: stat.label })
          ]
        },
        stat.label
      )) })
          ...
          !isLoading && !isError && members.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-black text-foreground text-2xl mb-3", children: "L'élite se révèle bientôt" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-sm text-base leading-relaxed", children: "Les profils de nos membres seront bientôt disponibles. Rejoignez l'élite Pantheon dès aujourd'hui." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.a,
                  {
                    href: "/#rejoindre",
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(ellipse, oklch(0.82 0.10 85) 0%, transparent 70%)"
              }
            }
          )
        }
