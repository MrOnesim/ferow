import { r as reactExports, j as jsxRuntimeExports, L as Link, R as React, a as useInternetIdentity, b as useQueryClient, c as useRouterState } from "./index-BoKHS30i.js";
import { c as createLucideIcon, M as MotionConfigContext, i as isHTMLElement, b as useConstant, P as PresenceContext, d as usePresence, e as useIsomorphicLayoutEffect, L as LayoutGroupContext, m as motion, u as useActor, f as useQuery, a as createActor } from "./backend-DCHKWvW6.js";
import { X } from "./x-s8pYLw9a.js";
/**
...
function Navbar() {
  ...
  const handleNavClick = (_href, hash) => {
    setIsOpen(false);
    if (hash && currentPath === "/") {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: cn(
        ...
        scrolled ? "bg-card/95 backdrop-blur-md border-b border-border/40 shadow-subtle" : "bg-transparent"
      ),
      "data-ocid": "navbar",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-primary flex items-center justify-center shadow-glow group-hover:shadow-glow-lg transition-shadow", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground font-display font-black text-sm tracking-tight", children: "FW" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-foreground text-xl tracking-tight hidden sm:block", children: "FEROW" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { "aria-label": "Navigation principale", className: "hidden lg:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex items-center gap-6", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: link.href,
              className: cn(
                "nav-link",
                currentPath === link.href.split("#")[0] && link.hash === "" ? "active text-foreground" : ""
              ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: cn(
                  ...
                  isAuthenticated ? "bg-secondary text-secondary-foreground hover:bg-secondary/80" : "bg-primary text-primary-foreground hover:opacity-90 shadow-elevated"
                ),
                "data-ocid": "navbar.auth_button",
                children: isInitializing ? "..." : isLoggingIn ? "Connexion..." : isAuthenticated ? "Déconnexion" : "Connexion"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-5 h-5 text-foreground" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "w-5 h-5 text-foreground" })
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.nav,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "container mx-auto px-4 py-4 flex flex-col gap-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "pt-2 border-t border-border/30 mt-2", children: [
                isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    to: "/admin",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: isAuthenticated ? "Se déconnecter" : "Se connecter"
                  }
                )
              ] })
            ] })
...
function Layout({ children, hideNav = false }) {
  ...
  const hostname = typeof window !== "undefined" ? window.location.hostname : "ferow.org";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    !hideNav && /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border/30 pt-16 pb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg bg-primary flex items-center justify-center shadow-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground font-display font-black text-sm", children: "FW" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-foreground text-2xl", children: "FEROW" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed max-w-xs mb-6", children: "Fédération Nationale des Mouvements de Soutien à Romuald Wadagni. Un mouvement dédié au leadership et à l'impact social." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-sm uppercase tracking-widest mb-4", children: "Navigation" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-sm uppercase tracking-widest mb-4", children: "Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2.5 text-muted-foreground text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 mt-0.5 text-primary flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Cotonou, République du Bénin" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2.5 text-muted-foreground text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-8 border-t border-border/20 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "© ",
          year,
          " FEROW. Tous droits réservés."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
...
export {
  ...
  ArticleCard as b,
  cn as c,
  useGetPublishedArticles as d,
  useGetArticleById as e,
