...
import { L as Layout, C as ChevronRight } from "./Layout-DC7T_d2S.js";
import { S as SectionHeading } from "./SectionHeading-CMmAf_cm.js";
import { u as useGetPhotos } from "./useGallery-CF3n2GKA.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-sm", children: "Les photos seront ajoutées prochainement par l'équipe FEROW. Revenez bientôt !" })
      ]
    }
  );
}
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                backgroundImage: "radial-gradient(circle at 70% 30%, oklch(0.38 0.16 264 / 0.4), transparent 60%)"
              },
              "aria-hidden": "true"
            }
          ),
