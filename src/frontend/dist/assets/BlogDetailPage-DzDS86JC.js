import { u as useParams, r as reactExports, j as jsxRuntimeExports, L as Link } from "./index-CFjb6K-E.js";
import { c as useGetArticleById, b as useGetPublishedArticles, C as Calendar, a as ArticleCard } from "./useArticles-DsiV039Y.js";
import { L as Layout, M as MessageCircle } from "./Layout-BU-ph7QX.js";
import { c as createLucideIcon, m as motion } from "./backend-DZFzHFEp.js";
import { A as ArrowLeft } from "./arrow-left-UWm3KBIQ.js";
import "./index-CT1y8vqp.js";
/**
...
function BlogDetailPage() {
  ...
  reactExports.useEffect(() => {
    ...
    return () => {
      document.title = "Pantheon — Mouvement National de Leadership et d'Impact Social";
    };
  }, [article]);
  ...
  const whatsappShare = `https://wa.me/?text=${encodeURIComponent(
    `${(article == null ? void 0 : article.title) ?? ""} — Découvrez cet article de Pantheon : ${shareUrl}`
  )}`;
  if (isLoading) {
